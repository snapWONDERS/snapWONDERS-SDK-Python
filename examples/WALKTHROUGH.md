...
> re-run since they shipped. `examples/analyse.py` already prints all of them when present — run it
> against your own file to see the live shape. Full field reference: `docs/reference/API.md` (in the
> main snapWONDERS repo).
