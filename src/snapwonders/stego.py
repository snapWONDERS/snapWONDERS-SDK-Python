...
class StegoSession:
    ...
    def __init__(self, transport: HttpTransport, upload_uid: str, *, session_type: str) -> None:
        self._t = transport
        self.upload_uid = upload_uid
    ...
    def upload(self, file_path: str | os.PathLike[str], *, step: int) -> str:
        ...
        return tus.upload_file(self._t, file_path, upload_uid=self.upload_uid, step=step)
...
class Stego:
    ...
    def create_session(self, session_type: str) -> StegoSession:
        ...
        return StegoSession(self._t, data["upload_uid"], session_type=session_type)
